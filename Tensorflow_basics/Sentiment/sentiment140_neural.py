...
# needed when using saver to restore tensor
current_epoch = tf.Variable(1)

x = tf.placeholder('float32')
y = tf.placeholder('float32')

# 2638 - size of the lexicon
...
use_neural_network("congratulatins.....you won.")
use_neural_network("neural networks are the phenominal")
